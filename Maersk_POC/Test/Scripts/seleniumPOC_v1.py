...
df1=pd.read_excel("C:\\Automation\\Maersk_POC\\TestData\\maersk_4_critical_input.xlsx",sheetname='Sheet2')
a=df1.T
addmultipleListCol=[]
indexx=list(a.index)
print(indexx)
...
writer = pd.ExcelWriter('C:\\Automation\\Maersk_POC\\Report\\maersk_3_critical_report.xlsx', engine='xlsxwriter')
