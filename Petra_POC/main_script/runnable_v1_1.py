...
import sys
#qq=sys.argv[1]
qq='C:\\Users\\29265\\Desktop\\petraInt'
f=open(qq+'\\cust\\config\\Config_Dimension_Cust.txt')
...
df_data=pd.read_csv(qq+'\\cust\\data\\Data_Dimension_Cust.csv')
...
#a+'\\cust\\data\\Data_Dimension_Cust.csv'
#df_data1=pd.read_csv("C:\\Users\\29265\\Desktop\\PetraImfFile\\Data_Dimension_Cust.csv")
df_data1=pd.read_csv(qq+'\\cust\\data\\Data_Dimension_Cust.csv')
...
#tt =sys.argv[2]
tt ='C:\\Users\\29265\\Desktop\\petraInt\\'
writer = pd.ExcelWriter(tt+'Petra_Report.xlsx', engine='xlsxwriter')
