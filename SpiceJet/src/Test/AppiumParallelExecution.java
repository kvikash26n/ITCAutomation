...
public class AppiumParallelExecution implements Runnable {
	...
	private void openAppAndPerformSomeActions() throws InvalidFormatException, IOException {
		...
		//	String sc = getScreenshot("Spicejet");
			...
			Thread.sleep(8000);
			driver.findElementById("com.vl.spicejet:id/etEmailId").sendKeys(testData.get(5).toString());
			...
			Thread.sleep(4000);
			driver.findElementById("com.vl.spicejet:id/etFirstName").sendKeys(testData.get(7).toString());
			driver.findElementById("com.vl.spicejet:id/etLastName").sendKeys(testData.get(8).toString());
			((PressesKeyCode) driver).pressKeyCode(AndroidKeyCode.BACK);
			...
			driver.findElementById("com.vl.spicejet:id/etCardNumber").sendKeys("10029001123");
			((PressesKeyCode) driver).pressKeyCode(AndroidKeyCode.BACK);
			Thread.sleep(5000);
